...
class FeeCalculatorTest {
    ...
    @Test
    public void for_age_above_14_WEEK_should_throw_exception()
    {
        //GIVEN
        Visitor adult = new Visitor(20);
        ...
        //THEN
        assertThat(error).isNotNull().isInstanceOf(IllegalArgumentException.class).hasMessage("Ticket type not supported");
    }

    @Test
    public void for_age_under_14_WEEK_should_throw_exception()
    {
        //GIVEN
        Visitor child = new Visitor(10);

        //WHEN
        IllegalArgumentException error = (IllegalArgumentException) catchException(() -> FeeCalculator.calculateFee(child, TicketType.WEEK));
